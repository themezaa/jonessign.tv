...
if(!class_exists('FPD_Admin_Menus')) {
	...
	class FPD_Admin_Menus {
		...
		public function add_menu_pages() {
			...
			//add fancy design categories sub menu page to products menu
			add_submenu_page(
				'fancy_product_designer',
				__('Fancy Designs Categories', 'radykal'),
				__('Fancy Designs Categories', 'radykal'),
				Fancy_Product_Designer::CAPABILITY,
				'edit-tags.php?taxonomy=fpd_design_category&post_type=attachment',
				null
			);
