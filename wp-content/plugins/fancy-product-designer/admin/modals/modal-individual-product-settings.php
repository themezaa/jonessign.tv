			...
			<table class="form-table radykal-form-settings">
				<tbody>
					<tr valign="top">
						...
						<td>
							<select name="product_designer_ui_layout" class="radykal-select2">
					...
					<tr valign="top">
						...
						<td>
							<select name="product_designer_visibility">
								<option value=""><?php _e( 'Use Option From Main Settings', 'radykal' ); ?></option>
								<?php
									//get all created categories
					...
					<tr valign="top">
						...
						<td >
							...
							<input type="hidden" value="<?php echo plugins_url('/img/grid.png', FPD_PLUGIN_ADMIN_DIR); ?>" name="background_image">
