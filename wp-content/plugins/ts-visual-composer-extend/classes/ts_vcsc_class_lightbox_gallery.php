	...
	if (!class_exists('TS_Image_Galleries')){
		class TS_Image_Galleries {
			function __construct() {
				...
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode == "true") {
					if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
						add_action('init',                                  array($this, 'TS_VCSC_Add_Lightbox_Gallery_Lean'), 9999999);
			...
			function TS_VCSC_LightboxGridImageDataArray($i, $p, $t, $a, $g) {
				return array('image' => (!empty($i) ? $i : ""), 'preview' => (!empty($p) ? $p : (!empty($i) ? $i : "")), 'title' => (!empty($t) ? $t : ""), 'alt' => (!empty($a) ? $a : ""), 'groups' => (!empty($g) ? $g : ""));
			}
					...
					if ((strtolower($content_style) == "first") || (strtolower($content_style) == "random")) {
						...
						foreach($content_combined as $image => $meta) {
							...
							if (($i == $modal_pick) || ($nachoLength == 0)) {
								...
								$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" style="display: none;" href="' . $modal_image . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" class="nch-lightbox-media no-ajaxy ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
								...
								foreach ($content_combined as $image => $meta) {
									...
									if ($i == $nachoLength) {
										...
										$modal_gallery .= '<div id="' . $nacho_group . '-' . $i .'-parent" class="ts-slickslider-section" style="margin: 0 ' . ($slickmain_spacing / 2) . 'px;" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '">';											
											if ($content_linkstyle != "none") {
												$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" data-thumb="' . $modal_thumb . '" class="' . $image_link_class . ' ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
											}
												...
												$modal_gallery .= '<div class="ts-slickslider-gallery-overlay"></div>';
												if (!empty($meta['title'])) {
										...
										$modal_gallery .= '<div id="' . $nacho_group . '-section-' . $i .'-parent" class="ts-slickslider-section" style="margin: 0 ' . ($slickmain_spacing / 2) . 'px;" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '">';											
											if ($content_linkstyle != "none") {
												$modal_gallery .= '<a id="' . $nacho_group . '-link-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" data-thumb="' . $modal_thumb . '" class="' . $image_link_class . ' ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" ' . $nacho_color . ' data-share="' . ($lightbox_social == "true" ? 1 : 0) . '">';
											}
												$modal_gallery .= '<img class="ts-slickslider-gallery-image" src="' . ($slickmain_lazyload == "true" ? "" : $preview_thumb) . '" data-lazy="' . ($slickmain_lazyload == "false" ? "" : $preview_thumb) . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-no-lazy="1" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" style="">';
												$modal_gallery .= '<div class="ts-slickslider-gallery-overlay"></div>';
												if (!empty($meta['title'])) {
							...
							$modal_gallery .= '<ul id="ts-pagawa-slideshow-wrapper-' . $randomizer . '" class="ts-pagawa-slideshow-wrapper" style="display: none;">';				
								foreach($content_combined as $image => $meta) {
									...
									if ($i == $nachoLength) {
										...
										$modal_gallery .= '<li>';
											if ($content_linkstyle != "none") {
												$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" data-thumb="' . $modal_thumb . '" class="' . $image_link_class . ' ts-pagawa-lightbox-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
											}
								...
								foreach($content_combined as $image => $meta) {
									...
									if ($i == $nachoLength) {
										...
										if ($content_linkstyle != "none") {
											...
											$modal_gallery .= '<img src="' . $preview_thumb . '" style="" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-transition-left="slideInLeft" data-transition-right="slideInRight" data-no-lazy="1" data-thumb="' . $thumb_image . '" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" >';
										if ($content_linkstyle != "none") {
											$modal_gallery .= '</a>';
										}
									} else {
				...
				$VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
					...
					"params"                        => array(
						...
						array(
							...
							"value"                 => "",
							"description"           => __( "Enter ALT tags for images; seperate individual images by line break; use an empty line for image without tag.", "ts_visual_composer_extend" )
						),
						// Gallery Info
						array(
							"type"                  => "seperator",
						...
						array(
							...
							"value"                 => "1024/2,480/1",
							"description"           => __( "Define the break points (to determine slide count) for the slider based on available screen size; seperate by comma and assign the number of slider to each breakpoint using the '/' character.", "ts_visual_composer_extend" ),
							"dependency"            => array( 'element' => "slickmain_singlemode", 'value' => 'singlenone' ),
							"group" 				=> "Layout"
						),
						array(
