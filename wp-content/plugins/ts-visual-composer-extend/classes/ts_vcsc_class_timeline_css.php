		...
		class TS_Timeline_CSS {
			function __construct() {
				...
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode == "true") {
					if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
						add_action('init',                                  array($this, 'TS_VCSC_Add_Timeline_CSS_Element_Lean'), 9999999);
						...
						$output .= '<div id="' . $timeline_id . '" class="ts-timeline-css-break ts-timeline-css-visible ' . $css_class . '" style="' . $break_width . ' ' . $vc_inline_style . '" data-fullwidth="' . $break_data . '" data-categories="' . $Section_Categories . '" data-tags="' . $Section_Tags . '" data-filtered-categories="false" data-filtered-tags="false">';
							$output .= '<div class="ts-timeline-css-text-wrap ' . $border_radius . ' ' . $tooltip_class . '" ' . $tooltip_content . ' style="' . $break_background . '">';
								$output .= '<div class="ts-timeline-css-text-wrap-inner" style="width: 100%; left: 0; ' . $title_margin . '">';
									...
									if (isset($Timeline_Breakcontent)) {
										if (function_exists('wpb_js_remove_wpautop')){
											$output .= '<div class="ts-timeline-css-text">' . wpb_js_remove_wpautop(do_shortcode($Timeline_Breakcontent), $wpautop) . '</div>';
										} else {
			...
			function TS_VCSC_Timeline_CSS_Function_Container ($atts, $content = null){
				...
				extract( shortcode_atts( array(
					...
					'timeline_border_default'		=> '#CCCCCC',
					'timeline_border_featured'		=> '#DDDDDD',
					'timeline_border_hover'			=> '#CCCCCC',
					
					'timeline_shadow_default'		=> '#EDEDED',
					'timeline_shadow_featured'		=> '#9BEF77',
					'timeline_shadow_hover'			=> '#42B0FF',
				...
				$output .= '<div id="' . $timeline_container_id . '" class="' . $css_class . ' ' . $timeline_class . '" data-type="timeline" data-layout="' . $timeline_layout . '" ' . $timeline_filter_data . ' data-sorter="' . $timeline_sort . '" data-switch="' . $timeline_switch . '" data-order="' . $timeline_order .'" data-lazy="' . $timeline_lazy . '" data-count="' . $timeline_count . '" data-trigger="' . $timeline_trigger . '" data-break="' . $timeline_break . '" style="margin-top: ' . $vcinline_margin . 'px; margin-bottom: ' . $margin_bottom . 'px; width: 100%;">';
					...
					if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode == "false") {
						$styles .= '<style id="' . $timeline_container_id . '-styles" type="text/css">';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-content .ts-timeline-css-text-wrap {';
								$styles .= 'border: 1px solid ' . $timeline_border_default . ';';
								$styles .= 'box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_default . ';';
								$styles .= '-webkit-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_default . ';';
								$styles .= '-moz-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_default . ';';
								$styles .= '-o-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_default . ';';
							$styles .= '}';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-content .ts-timeline-css-text-wrap:hover {';
								$styles .= 'border: 1px solid ' . $timeline_border_hover . ';';
								$styles .= 'box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_hover . ';';
								$styles .= '-webkit-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_hover . ';';
								$styles .= '-moz-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_hover . ';';
								$styles .= '-o-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_hover . ';';
							$styles .= '}';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-fullwidth .ts-timeline-css-text-wrap {';
								$styles .= 'border: 1px solid ' . $timeline_border_featured . ';';
								$styles .= 'box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_featured . ';';
								$styles .= '-webkit-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_featured . ';';
								$styles .= '-moz-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_featured . ';';
								$styles .= '-o-box-shadow: 0px 0px 3px 3px ' . $timeline_shadow_featured . ';';
							$styles .= '}';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-columns .ts-timeline-css-event-left:hover:after,';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-columns .ts-timeline-css-event-right:hover:after,';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-left .ts-timeline-css-event:hover:after,';
							$styles .= '#' . $timeline_container_id . '.ts-timeline-css-container .ts-timeline-css-right .ts-timeline-css-event:hover:after {';
								$styles .= 'border: 4px solid ' . $timeline_shadow_hover . ';';
							$styles .= '}';
						$styles .= '</style>';				
						$output .= $styles;
					}
			...
			function TS_VCSC_Add_Timeline_CSS_Element_Container() {
				...
				$VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
					...
					"params"                            => array(
						...
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Border Color: Default", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_border_default",
							"value"             		=> "#CCCCCC",
							"description"       		=> "",
						),
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Border Color: Featured", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_border_featured",
							"value"             		=> "#DDDDDD",
							"description"       		=> "",
						),
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Border Color: Hover", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_border_hover",
							"value"             		=> "#CCCCCC",
							"description"       		=> "",
						),
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Shadow Color: Default", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_shadow_default",
							"value"             		=> "#EDEDED",
							"description"       		=> "",
						),
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Shadow Color: Featured", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_shadow_featured",
							"value"             		=> "#9BEF77",
							"description"       		=> "",
						),
						array(
							"type"              		=> "colorpicker",
							"heading"           		=> __( "Shadow Color: Hover", "ts_visual_composer_extend" ),
							"param_name"        		=> "timeline_shadow_hover",
							"value"             		=> "#42B0FF",
							"description"       		=> "",
						),
						// Sort Settings
