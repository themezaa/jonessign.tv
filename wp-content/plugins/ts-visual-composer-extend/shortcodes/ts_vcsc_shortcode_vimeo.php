	...
	function TS_VCSC_Vimeo_Function ($atts, $content = null) {
		...
		if ($content_lightbox == "true") {
			...
			$output .= '<div id="' . $modal_id . '" class="ts-video-container ' . $vimeo_tooltipclasses . '" ' . $vimeo_tooltipcontent . '>';
				$output .= '<iframe class="ts-video-iframe" src="https://player.vimeo.com/video/' . $modal_image . $video_autoplay . '" width="100%" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
			$output .= '</div>';
		}
