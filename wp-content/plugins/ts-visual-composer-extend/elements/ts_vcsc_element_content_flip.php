    ...
    $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
		...
		"params"                    => array(
			...
			array(
				...
				"std"				=> "h3",
				"default"			=> "h3",
				"description"       => __( "Select what tag type should be used to wrap the front title.", "ts_visual_composer_extend" ),
				"group" 			=> "Content",
			),			
			array(
				"type"				=> "fontsmanager",
			...
			array(
				...
				"std"				=> "h3",
				"default"			=> "h3",
				"description"       => __( "Select what tag type should be used to wrap the back title.", "ts_visual_composer_extend" ),
				"group" 			=> "Content",
			),			
			array(
				"type"				=> "fontsmanager",
