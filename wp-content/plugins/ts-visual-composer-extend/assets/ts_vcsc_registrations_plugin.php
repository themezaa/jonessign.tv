<?php
	...
	function TS_VCSC_Admin_Notice_Version() {
		echo '<div class="updated"><p>The <strong>Composium - Visual Composer Extensions</strong> add-on requires <strong>Visual Composer</strong> version 4.7.4 or greater.</p></div>';	
	}
