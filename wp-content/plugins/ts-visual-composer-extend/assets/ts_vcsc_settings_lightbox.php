	...
	<div id="ts_vcsc_extend_settings_builtinLightbox_true" class="ts-vcsc-section-main" style="display: <?php echo ($ts_vcsc_extend_settings_builtinLightbox == 1 ? 'block' : 'none'); ?>;">
		...
		<div class="ts-vcsc-section-content">
			...
			<div style="margin-top: 20px;">
				...
				<p style="font-size: 12px;">Define if the lightbox should attempt to use CORS requests to analyze image data; enable only if images are retrieved cross-domain from a CORS enabled server, as it will increase image loading times:</p>
