		...
		<div class="ts-vcsc-section-main">
			...
			<div class="ts-vcsc-section-content">
				...
				<div id="ts_tiny_generator_container" style="border: none; padding: 10px;">
					...
					<button style="margin-top: 10px; margin-right: 20px; width: 200px; display: inline-block;" data-clipboard-action="copy" data-clipboard-target="#ts_tiny_tinymce_html_copy" type="button" value="<?php _e( "Copy HTML Code", "ts_visual_composer_extend" ); ?>" name="ts_tiny_clipboard_copy_html" id="ts_tiny_clipboard_copy_html" class="button-secondary" data-error="<?php _e( "No Icon HTML Code has been generated yet.", "ts_visual_composer_extend" ); ?>" data-success="<?php _e( "Icon HTML Code has been copied to Clipboard.", "ts_visual_composer_extend" ); ?>"/><?php _e( "Copy HTML Code", "ts_visual_composer_extend" ); ?></button>
				</div>
