            ...
            function imagehotspot_settings_field($settings, $value) {
				...
				$output .= '<div id="ts-image-hotspot-container-wrapper-' . $random_id_number . '" class="ts-image-hotspot-container-wrapper clearFixMe ts-settings-parameter-gradient-grey">';
					...
					$output .= '<div id="ts-nouislider-hotspot-slider-horizontal-' . $random_id_number . '" class="ts-nouislider-hotspot-slider clearFixMe">';
						...
						$output .= '<input id="ts-input-hotspot-horizontal" style="width: 100px; float: left; margin-left: 0px; margin-right: 10px;" name="" class="ts-input-hotspot-horizontal ts-nouislider-serial nouislider-input-selector nouislider-input-composer" type="text" max="100" min="0" step="1" value="' . $coordinates[0] . '"/>';
						...
						$output .= '<div id="ts-nouislider-hotspot-horizontal-' . $random_id_number . '" class="ts-nouislider-input ts-nouislider-hotspot-element ts-nouislider-hotspot-horizontal" data-position="horizontal" data-unit="' . $unit . '" data-value="' . $coordinates[0] . '" data-min="' . $min . '" data-max="' . $max . '" data-decimals="' . $decimals . '" data-step="' . $step . '" style="width: 250px; float: left; margin-top: 10px;"></div>';
					$output .= '</div>';
					// Y-Position Slider
					$output .= '<div id="ts-nouislider-hotspot-slider-vertical-' . $random_id_number . '" class="ts-nouislider-hotspot-slider clearFixMe">';
						$output .= '<div class="" style="font-weight: bold;">' . __( "Vertical Position (Y)", "ts_visual_composer_extend" ) . '</div>';
						$output .= '<input id="ts-input-hotspot-vertical" style="width: 100px; float: left; margin-left: 0px; margin-right: 10px;" name="" class="ts-input-hotspot-vertical ts-nouislider-serial nouislider-input-selector nouislider-input-composer" type="text" max="100" min="0" step="1" value="' . $coordinates[1] . '"/>';
						$output .= '<span style="float: left; margin-right: 30px; margin-top: 10px; min-width: 10px;" class="unit">' . $unit . '</span>';
						$output .= '<span class="ts-nouislider-input-down dashicons-arrow-left-alt2" style="position: relative; float: left; display: inline-block; font-size: 30px; top: 5px; cursor: pointer; margin: 0;"></span>';
						$output .= '<span class="ts-nouislider-input-up dashicons-arrow-right-alt2" style="position: relative; float: left; display: inline-block; font-size: 30px; top: 5px; cursor: pointer; margin: 0 20px 0 0;"></span>';
