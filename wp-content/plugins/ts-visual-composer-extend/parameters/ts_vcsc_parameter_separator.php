    ...
    if (!class_exists('TS_Parameter_Separator')) {
        class TS_Parameter_Separator {
            ...
            function seperator_settings_field($settings, $value) {
                ...
                $output         = '';
                if ($seperator != '') {
                    $output		.= '<div id="' . $param_name . '" class="ts-settings-panel-separator wpb_vc_param_value ' . $param_name . ' ' . $type . '" name="' . $param_name . '">' . $seperator . '</div>';
                } else {
                    $output		.= '<div id="' . $param_name . '" class="ts-settings-panel-separator wpb_vc_param_value ' . $param_name . ' ' . $type . '" name="' . $param_name . '">' . $value . '</div>';
                }
                return $output;
            }
        }
