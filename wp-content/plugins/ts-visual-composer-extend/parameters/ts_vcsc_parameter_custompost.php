                ...
                $output .= '<div id="ts-custompost-selector-wrapper-' . $randomizer . '" class="ts-custompost-selector-wrapper ts-settings-parameter-gradient-grey">';
                    $output .= '<div class="ts-custompost-selector-parent" data-selectable="' . __( "Available Categories:", "ts_visual_composer_extend" ) . '" data-selection="' . __( "Filtered By:", "ts_visual_composer_extend" ) . '">';
                        if (count($category_fields) > 1) {
                            ...
                            $output .= '<div class="ts-switch-button ts-composer-switchblock" data-value="false" data-width="100" data-style="compact" data-on="' . __( "Show", "ts_visual_composer_extend" ) . '" data-off="' . __( "Hide", "ts_visual_composer_extend" ) . '">';
                                ...
                                $output .= '<div class="toggle toggle-light" style="width: 100px; height: 20px;">';
                                ...
                                $output .= '</div>';
                            $output .= '</div>';
                            $output .= '<span class="ts-custompost-selector-message" style="margin-bottom: 20px;">' . __( "Switch the toggle if you want to show controls to filter available post types by categories.", "ts_visual_composer_extend" ) . '</span>';
                            // Categories Filter
                            $output .= '<div class="ts-custom-post-filter-frame" style="display: none; margin-bottom: 20px;">';
                                ...
                                $output .= '</select>';
                                $output .= '<span class="ts-custompost-selector-message">' . __( "Click on 'Available Categories' to filter by category; click on 'Flitered By' to remove from filter.", "ts_visual_composer_extend" ) . '</span>';
                            $output .= '</div>';
                        }
            ...
            function custompostcat_settings_field($settings, $value) {
                ...
                $output .= '<div id="ts-custompost-categories-wrapper-' . $randomizer . '" class="ts-custompost-categories-wrapper ts-settings-parameter-gradient-grey">';
                    $output .= '<div class="ts-custompost-categories-holder">';
                        ...
                        $output .= '</select>';
                        $output .= '<span class="ts-custompost-selector-message">' . __( "Click on a name in 'Available Categories' to add category to slider; click on a name in 'Applied Categories' to remove from slider.", "ts_visual_composer_extend" ) . '</span>';
                    $output .= '</div>';
                $output .= '</div>';
                return $output;
            }
                    ...
                    $output .= '<div id="ts-custompost-categories-wrapper-' . $randomizer . '" class="ts-custompost-categories-wrapper ts-settings-parameter-gradient-grey">';
                        if ($postmulti == "true") {                        
                            $output .= '<div class="ts-custompost-categories-holder">';
                                ...
                                $output .= '</select>';
                                $output .= '<span class="ts-custompost-selector-message">' . __( "Click on a name in 'Available Categories' to add category to slider; click on a name in 'Applied Categories' to remove from element.", "ts_visual_composer_extend" ) . '</span>';
                            $output .= '</div>';
                        } else {
                            $output .= '<div class="ts-custompost-categories-holder">';
