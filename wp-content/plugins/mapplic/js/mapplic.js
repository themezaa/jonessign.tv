	...
	var Mapplic = function(element) {
		...
		function Sidebar() {
			...
			this.addLocation = function(data) {
				...
				var link = $('<a class="location"></a>').attr('href', '#').click(function(e) {
					e.preventDefault();
				...
				$('<span class="location-title"></span>').text(data.title).appendTo(link)
				$('<span class="location-phone"></span>').html(data.about).appendTo(link);
