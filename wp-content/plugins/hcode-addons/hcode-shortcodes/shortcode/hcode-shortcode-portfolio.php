                            ...
                            $output .='<figure>';
                                ...
                                if(!empty($portfolio_image)){
                                    ...
                                    if($url):
                                        ...
                                        $output .= '<div class="gallery-img">';
                                            if($enable_lightbox == 'lightbox-gallery'):
                                                $output .= '<a href="' . HCODE_THEME_ASSETS_URI . '/images/no-image.jpg" width="900" height="600" alt="" class="lightboxgalleryitem" data-group="general"/>';
                                            else:
                                                $output .= '<a href="'.get_permalink().'">';
                                            endif;
                                ...
                                elseif(!empty($portfolio_link)){
                                    ...
                                    $output .= '<div class="gallery-img">';
                                            ...
                                            if ( $url ) {
                                                ...
                                                $output .= '<img alt="" src="' . HCODE_THEME_ASSETS_URI . '/images/no-image.jpg" width="900" height="600" />';
                                            }
                                        $output .= '</a>';
                                    $output .= '</div>';
                                    ...
                                    if($url):
                                        ...
                                        $output .= '<div class="gallery-img">';
                                            if($enable_lightbox == 'lightbox-gallery'):
                                                $output .= '<a href="' . HCODE_THEME_ASSETS_URI . '/images/no-image.jpg" width="900" height="600" class="lightboxgalleryitem" data-group="general">';
                                            else:
                                                $output .= '<a href="'.get_permalink().'">';
                                            endif;
                                                $output .= '<img src="' . HCODE_THEME_ASSETS_URI . '/images/no-image.jpg" width="900" height="600" alt=""/>';
