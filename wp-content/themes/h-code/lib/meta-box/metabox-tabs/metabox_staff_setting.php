...
hcode_meta_box_text('hcode_subtitle_single',
				esc_html__('Staff Name on Hover', 'H-Code'),
				esc_html__('Display Staff Name on Hover of the Featured Image', 'H-Code')
			);
...
hcode_meta_box_dropdown(	'hcode_image_single',
				esc_html__('Featured Image in Staff Page', 'H-Code'),
				array('' => esc_html__('Select Image', 'H-Code'),
					'no' => esc_html__('No', 'H-Code'),
