...
/**
 *
 * ADVANCED CUSTOM FIELDS TESTIMONIAL SETUP USING THE TESTIMONIAL CUSTOM FIELDS GROUP
 *
 */
...
$quoteSource = !empty( $linked_url ) ? $linkedIn: $source; // if there is a linkedin link, then use a link to it around the quote source
...
//$overlay        = 'background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7) )'; // this overlay is black, comment it out if yo//u'd prefer the blue overlay on your header
...
//
// PRINT
$printThis = '<span class="pdf-button"><a class="print-to-pdf" rel="nofollow" href="#" title="Print to PDF" onclick="window.print();return false;">Print PDF
			<img class="pdf-print-link" src="http://jonessign.tv/wp-content/uploads/2016/09/Printer.svg" alt="print this project profile to PDF" />
			</a></span>' ;
?>
 ...
 <!-- BEGIN DIV CONTAINING CLIENT OR JOB NAME AS WELL AS A QUOTE ABOUT THE PROJECTIF AVAILABLE -->
	...
	<div id="jones-project-header" class="container">
		<div  class="row">
			...
			<!-- non-plugin pdf print button -->
			<?php echo $printThis; ?>
			<!-- end non plugin pdf button-->

			<!-- pdf print button from plugin
...
<div id="quote-container" class="container">
	<div class="row">
		<blockquote class="blockquote-reverse">
			...
			<footer>
			<?php echo $quote['source'] . ' - <em>' . $quote['position'] . '</em> | ' . $quote['company']; ?>
