<?php
/**
 * displaying layout for archive of position pages - to display position openings at jones sign company, search page
 * this is called from the /template/archive-position.php page
        ...
        $output .= '<div class="container">';
            $output .= '<div class="row">';
                $output .= '<div class="col-lg-8 col-md-7 col-md-12 col-sm-12 animated fadeInUp">';
                        $output .= '<h1 class="black-text">'.$title.' </h1><h5><!-- uses /templates/position/archive-position.php--></h5> ';
                $output .= '</div>';
...
<section class="parent-section <?php echo $section_class.' '.$hcode_header_menu_type; ?>">
    <div class="<?php echo $class_main_section; ?>">
            <div class="row">
                ...
                <?php get_template_part('templates/page-content/'.$hcode_layout_settings.'/content',get_post_format()); ?>
