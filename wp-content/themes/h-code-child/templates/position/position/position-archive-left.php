...
switch ($layout_settings) {
	case 'hcode_general_left_sidebar':
		echo '<div class="col-md-8 col-sm-8 col-md-offset-1 xs-margin-bottom-seven pull-right xs-pull-none">';
		break;
	...
	case 'hcode_general_both_sidebar':
		...
		echo '</div>';
            echo '<div class="col-md-3 col-sm-6 sidebar pull-right xs-margin-top-seven">';
