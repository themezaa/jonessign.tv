...
if($enable_header == '1' || $enable_header == '2'){
    ...
    ?>
    <nav id="hidden-on-pdf" class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav <?php echo $classes.$hcode_header_text_color." ".$enable_sticky;?>">
        <div class="container">
            <!-- logo -->
                ...
                ?>
                    ...
                    if(!empty($hcode_header_light_logo) || $retina_light){
                        ...
                        if(!in_array($hcode_header_layout, $header_type) ){
                            ?>
                            <a class="logo-dark" href="<?php echo home_url(); ?> child theme menu.php">
                                <?php
