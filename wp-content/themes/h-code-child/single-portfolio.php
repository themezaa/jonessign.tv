...
<?php
    ...
    $layout_settings        = '';
    $enable_container_fluid = '';
    $class_main_section     = '';
    $section_class          = '';
    // Get hcode theme options
    ...
    if( !empty($layout_settings)){
        ...
        switch ($layout_settings) {
            ...
            default:
                ...
                $class_main_section .= 'container';
            break;
        } //end switch for layout settings
?>
            ...
            <div class="<?php echo $class_main_section; ?>">
                <div class="row">
                    <?php
                        ...
                        get_template_part('templates/portfolio/portfolio-sidebar-left');
                    ?>
                    <?php
                        //Standard Portfolio layout.
                        get_template_part('templates/portfolio/single-portfolio/portfolio','single');
                    ?>
                    <?php
                    	//pages links
                    	wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'H-Code' ), 'after'  => '</div>', ) );
                    ?>
                    <?php
                        // If Is Set Get Post Right Sidebar.
                        get_template_part('templates/portfolio/portfolio-sidebar-right');
                    ?>
                </div>
            </div>
        </section>
    <?php
    	...
    	// this is the option I am going with on the portfolio pages
...
?>
        <div class="next-previous-bottom hide-print">
