 ...
 * altered in my child theme to point to a style sheet specifically for printing
...
<head>
    ...
    ?>
    <link type="text/css" media="print" rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/additional_css/print.css" />
