...
/**
 *
 * TESTIMONIAL SETUP for PORTFOLIO
 *
 */
...
$overlay        = 'background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7) )'; // this overlay is black, comment it out if you'd prefer the blue overlay on your header
 ...
 <!-- BEGIN DIV CONTAINING CLIENT OR JOB NAME AS WELL AS A QUOTE ABOUT THE PROJECTIF AVAILABLE -->
	...
	<div id="jones-project-header" class="container">
		<div  class="row">
			...
			?>
				<div id="project-client-information" class="full-width-headline flex col-nw justify-space-around align-items-center alt-font">
					...
					<!-- if we have a testimonial to attach, attach it here, in the header -->
					<?php if($quote['testimonial']){ ?>
					<!-- begin testimonial -->
					<blockquote id="header-testimonial" class="blockquote-reverse" style="background:rgba(255,255,255,0.25); border: 4px solid rgba(255,255,255,0.55);color:white;font-weight: 400;">
					<p> <?php echo $quote['testimonial']; ?> </p> <!-- end quote -->
					<footer style="color:white;">
					<?php echo $quote['source'] . ' - ' . $quote['position'] . $quote['company']; ?>
...
<div id="project-square-images-container" class="container">
	...
	<div class="container">
		<div class="row">
			<div class="wpb_column vc_column_container col-xs-mobile-fullwidth col-sm-12">
				...
				<!-- make sure the script is located outside of the containing element of the while loop, otherwise it adds an additional empty slide at the back for some godforsaken reason-->
...
<!-- CONTENT MANUFACTURED IN VISUAL COMPOSER -->
...
<!-- ADDITIONAL DIV FOR PRINTING A PORTFOLIO PAGE, NOT VISIBLE UNLESS YOU ARE PRINTING-->
<!-- containing div for what is being printed -->
<div id="print-pdf" class="print-only">

	<div id="print-footer" class="print-only">
		<!-- list all the jones locations by city -->
		<div class="list-all-locations" style="padding:2vw;">

		<?php
		//get an array of all the custom post type:location
		$myquery = new WP_Query( array( 'post_type' => 'jones-location' ) );
			while ( $myquery->have_posts() ) : $myquery->the_post();
			$location_title[] = get_the_title();
			echo $location_title[3];
		...
		</div><!-- end div.list-all-locations -->
	</div><!-- end div.footer -->
</div><!-- end div#print-pdf END containing div for what is being printed-->


<!-- END ADDITIONAL DIV FOR PRINTING A PORTFOLIO PAGE, NOT VISIBLE UNLESS YOU ARE PRINTING-->